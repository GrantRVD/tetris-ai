...
public class JTetris extends JComponent {
	...
	protected TetrisController tc; // Implements the logic of the game
	
	// The following fields will be used when we want to generate a non-Random sequence of pieces for testing.
	// a, b, and seed can be changed to create a different sequence.
	final int a = 4;
	final int b = 3;
...

	{
		...
		//JTetris tetris = new JTetris(TetrisController.WIDTH*pixels+2, (TetrisController.HEIGHT+TOP_SPACE)*pixels+2);	
